...
function PoetryContent({ siteUrl }: { siteUrl: string }) {
  const { t } = useLanguage();
      ...
      <section className="relative pt-20 pb-10 sm:pb-12 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <AnimatedSection>
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold gradient-text mb-4 leading-[1.06] pb-[0.06em]">
              {t.sections.poetry}
            </h1>
...
export function PoetryPageClient({ siteUrl }: { siteUrl: string }) {
  return (
    <Suspense
      fallback={
