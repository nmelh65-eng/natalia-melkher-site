...
export default function AIFloatingButton({
  ...
  return (
    <button
      ...
      className="group fixed bottom-2.5 sm:bottom-6 right-2.5 sm:right-6 z-[90] flex h-9 w-9 sm:h-14 sm:w-14 items-center justify-center rounded-[17px] sm:rounded-full border border-white/[0.09] bg-gradient-to-br from-purple-600 via-fuchsia-500 to-amber-400 text-white shadow-[0_8px_18px_rgba(124,58,237,0.22)] hover:-translate-y-0.5 hover:shadow-[0_12px_24px_rgba(124,58,237,0.28)] active:scale-95 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-purple-400/18"
    >
      <span
        aria-hidden="true"
      ...
      <svg
        className="relative z-10 w-[16px] h-[16px] sm:w-7 sm:h-7 group-hover:scale-105 transition-transform"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.8"
