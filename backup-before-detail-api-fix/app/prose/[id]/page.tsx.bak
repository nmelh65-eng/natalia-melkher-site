...
export default function ProsePiecePage() {
  ...
  // Находим похожие произведения по тегам
  const related = getWorksByCategory("prose")
    .filter(
      (p) =>
  ...
  if (!work || work.category !== "prose") {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-6 px-4 text-center">
        ...
        <Link
          href="/prose"
          className="px-8 py-3 rounded-2xl bg-amber-600 text-white
    ...
    <div className="min-h-screen">
      ...
      <div
        ...
        className="fixed top-0 left-1/2 -translate-x-1/2
                   w-[700px] h-[500px] bg-amber-500/5 rounded-full
      ...
      <div className="max-w-2xl mx-auto px-4 pt-16 pb-28 relative z-10">
        ...
        <AnimatedSection delay={0}>
          <button
            ...
            className="inline-flex items-center gap-2 text-gray-600
                       hover:text-amber-400 transition-colors mb-14
                       group text-sm
                       focus:outline-none focus:text-amber-400"
          >
            <span
          ...
          <div className="mb-14">
            <div
              className="inline-flex items-center gap-2 px-4 py-1.5
                         rounded-full bg-amber-500/10 border border-amber-500/20 mb-8"
            >
        ...
        <AnimatedSection delay={160}>
          <article className="glass-gold rounded-3xl overflow-hidden mb-10">
            <div
              aria-hidden="true"
            ...
            <div className="p-8 sm:p-12 md:p-16 work-content">
              <div className="space-y-6">
                {paragraphs.map((para, i) => {
                  ...
                  if (isQuote) {
                    paragraphClass +=
                      "pl-6 border-l-2 border-amber-400/30 text-gray-400 italic ";
                  }
        ...
        <AnimatedSection delay={240}>
          <nav aria-label="Теги произведения" className="flex flex-wrap gap-2 mb-14">
            {work.tags.map((tag) => (
              <Link
                key={tag}
                ...
                {related.map((piece) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        aria-hidden="true"
                        className="h-0.5 bg-gradient-to-r from-amber-500 to-purple-500
                      ...
                      <p className="text-xs text-gray-700 mt-2">
                        {piece.readingTime} {t.sections.minuteRead} &middot;{" "}
                        {piece.views} {t.sections.views}
                      </p>
                    </Link>
                  );
                })}
        ...
        {/* Кнопка «все произведения» */}
        <AnimatedSection delay={380}>
          <div>
            <Link
              href="/prose"
              className="inline-flex items-center gap-2 px-8 py-4
                         rounded-2xl glass text-amber-300
                         hover:text-white hover:bg-amber-500/20
