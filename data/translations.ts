...
export const translations: Translations = {
  ru: {
    ...
    sections: { latestWorks: "Последние произведения", poetry: "Поэзия", prose: "Проза", featured: "Избранное", allWorks: "Все", readMore: "Читать далее", backToHome: "На главную", minuteRead: "мин", views: "просмотров", likes: "нравится", publishedOn: "Опубликовано", tags: "Теги", noWorksFound: "Произведения не найдены", searchPlaceholder: "Искать...", inviteFirstRead: "Станьте первым читателем", inviteFirstHeart: "Оцените первым" },
  ...
  en: {
    ...
    sections: { latestWorks: "Latest Works", poetry: "Poetry", prose: "Prose", featured: "Featured", allWorks: "All", readMore: "Read More", backToHome: "Back Home", minuteRead: "min", views: "views", likes: "likes", publishedOn: "Published", tags: "Tags", noWorksFound: "No works found", searchPlaceholder: "Search...", inviteFirstRead: "Be the first to read", inviteFirstHeart: "Rate it first" },
  ...
  de: {
    ...
    sections: { latestWorks: "Neueste Werke", poetry: "Poesie", prose: "Prosa", featured: "Empfohlen", allWorks: "Alle", readMore: "Weiterlesen", backToHome: "Startseite", minuteRead: "Min", views: "Aufrufe", likes: "Gefällt", publishedOn: "Veröffentlicht", tags: "Tags", noWorksFound: "Keine Werke gefunden", searchPlaceholder: "Suchen...", inviteFirstRead: "Seien Sie der erste Leser", inviteFirstHeart: "Bewerten Sie zuerst" },
  ...
  fr: {
    ...
    sections: { latestWorks: "Dernières œuvres", poetry: "Poésie", prose: "Prose", featured: "En vedette", allWorks: "Tout", readMore: "Lire la suite", backToHome: "Accueil", minuteRead: "min", views: "vues", likes: "j'aime", publishedOn: "Publié", tags: "Tags", noWorksFound: "Aucune œuvre trouvée", searchPlaceholder: "Rechercher...", inviteFirstRead: "Soyez le premier à lire", inviteFirstHeart: "Réagissez en premier" },
  ...
  zh: {
    ...
    sections: { latestWorks: "最新作品", poetry: "诗歌", prose: "散文", featured: "精选", allWorks: "全部", readMore: "阅读更多", backToHome: "返回首页", minuteRead: "分钟", views: "浏览", likes: "喜欢", publishedOn: "发布于", tags: "标签", noWorksFound: "未找到作品", searchPlaceholder: "搜索...", inviteFirstRead: "成为首位读者", inviteFirstHeart: "抢先点赞" },
  ...
  ko: {
    ...
    sections: { latestWorks: "최신 작품", poetry: "시", prose: "산문", featured: "추천", allWorks: "전체", readMore: "더 읽기", backToHome: "홈으로", minuteRead: "분", views: "조회", likes: "좋아요", publishedOn: "게시", tags: "태그", noWorksFound: "작품 없음", searchPlaceholder: "검색...", inviteFirstRead: "첫 독자가 되어 보세요", inviteFirstHeart: "첫 반응을 남겨 보세요" },
